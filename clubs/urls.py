...
urlpatterns = [
    ...
    # Канонический маршрут (как был)
    path('detail/<int:pk>/create_player/', views.create_player, name='create_player'),

    # ✅ Алиасы, чтобы фронт-URL /clubs/<pk>/create_player/ тоже работал:
    path('<int:pk>/create_player/', views.create_player, name='create_player_alias'),
    path('<int:pk>/create-player/', views.create_player, name='create_player_dash'),

...
from clubs.api_views import my_club, club_summary, club_players, create_club, club_run_training
...
urlpatterns = [
    ...
    path("clubs/<int:club_id>/run-training/", club_run_training, name="api-club-run-training"),
]

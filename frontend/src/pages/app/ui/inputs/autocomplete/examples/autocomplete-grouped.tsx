      ...
      <Card>
        <CardContent>
          ...
          <FormControl fullWidth>
            <FormLabel component="label">Grouped by Titles</FormLabel>

            <Autocomplete
              size="small"
              popupIcon={<NiChevronDownSmall />}
              clearIcon={<NiCross />}
              options={optionsGrouped.sort((a, b) => -b.firstLetter.localeCompare(a.firstLetter))}
              groupBy={(option) => option.firstLetter}
              getOptionLabel={(option) => option.title}
              renderInput={(params) => (
                <TextField {...params} placeholder="Grouped by Titles" variant="standard" className="outlined" />
              )}
              slotProps={{

...
export default function IllustrationIntegrate({ className }: IllustrationProps) {
  return (
    ...
    >
      <path
        d="M182.75 77H197C199.209 77 201 78.7909 201 81L201 163C201 165.209 199.209 167 197 167H83C80.7909 167 79 165.209 79 163V81C79 78.7909 80.7909 77 83 77L97.25 77"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      ...
      <circle cx="169" cy="38" r="2" fill="currentColor" fillOpacity="0.1" />
      <circle cx="244" cy="226" r="2" fill="currentColor" fillOpacity="0.1" />
      <path
        d="M103 192H178C180.209 192 182 193.791 182 196V228C182 230.209 180.209 232 178 232H103C100.791 232 99 230.209 99 228V196C99 193.791 100.791 192 103 192Z"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      ...
      />
      <path
        d="M125.5 174L97.5 174C88.2525 174 80.7559 181.611 80.7559 191C80.7559 200.389 88.2525 208 97.5 208"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
        strokeDasharray="5 5"
      />
      <path
        d="M109.444 77H170.556C172.056 77 173.431 77.8397 174.115 79.1747L182.691 95.8983C182.878 96.2618 182.824 96.7021 182.557 97.0105L140.755 145.131C140.356 145.59 139.644 145.59 139.245 145.131L97.4434 97.0105C97.1756 96.7021 97.1222 96.2618 97.3085 95.8983L105.885 79.1747C106.569 77.8397 107.944 77 109.444 77Z"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
      />

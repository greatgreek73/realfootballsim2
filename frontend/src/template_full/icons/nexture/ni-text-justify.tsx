...
export default function NiTextJustify({
  className,
  variant = "outlined",
  size = "medium",
  oneTone = false,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <path d="M4 18L20 18" stroke="currentColor" strokeWidth={iconStrokeWidth} strokeLinecap="round" />
      </svg>
    );
  } else {
    return (
      ...
      >
        ...
        />
        <path
          d="M20 17.25C20.4142 17.25 20.75 17.5858 20.75 18C20.75 18.4142 20.4142 18.75 20 18.75L4 18.75C3.58579 18.75 3.25 18.4142 3.25 18C3.25 17.5858 3.58579 17.25 4 17.25L20 17.25Z"
          fill="currentColor"
        />
      </svg>
    );

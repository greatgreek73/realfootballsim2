...
class RegisterView(FormView):
    ...
    def form_valid(self, form):
        ...
        if hasattr(user, 'club'):
            return redirect('clubs:club_detail', kwargs={'pk': user.club.pk})  # Используем имя URL из вашего приложения clubs
        else:
            return redirect('clubs:create_club')  # Имя URL для страницы создания клуба

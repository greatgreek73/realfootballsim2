...
positions = [
    ...
    'Defensive Midfielder', 'Left Defensive Midfielder', 'Right Defensive Midfielder',
    'Right Midfielder', 'Central Midfielder', 'Left Midfielder',
    'Attacking Midfielder', 'Center Forward'
]

# Генерация и вывод характеристик для всех позиций
for pos in positions:
    stats = generate_player_stats(pos)
    print(f"{pos}: {stats}")

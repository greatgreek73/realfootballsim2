...
def generate_player_stats(position):
    ...
    weights = {
        ...
        'Right Back': {'tackling': 0.3, 'marking': 0.2, 'crossing': 0.1},
        'Left Back': {'tackling': 0.3, 'marking': 0.2, 'crossing': 0.1},
        'Center Back': {'marking': 0.3, 'tackling': 0.2, 'heading': 0.1},
        'Defensive Midfielder': {'tackling': 0.3, 'marking': 0.2, 'passing': 0.1},
        'Left Defensive Midfielder': {'tackling': 0.3, 'marking': 0.2, 'crossing': 0.1},
        'Right Defensive Midfielder': {'tackling': 0.3, 'marking': 0.2, 'crossing': 0.1},
        ...
        'Center Forward': {'finishing': 2.3, 'pace': 0.2, 'heading': 0.1}
    }
